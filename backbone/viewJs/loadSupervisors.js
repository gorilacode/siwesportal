$(document).ready(function(){
	...
	function image_loaded() {
		...
		function get_table_data(){
			...
			$.ajax({
				url: '../../backbone/controller/getSupervisors.php',
				type: 'POST',
				data: {key : key},
				dataType: 'json',
				beforeSend: function(){
		...
		$("body").on("click",".view-value", function(){
			...
			$("#view-values").find("div[id='dateview']").html(firstName);
			$("#view-values").find("div[id='activity']").html(lastName);
			$("#view-values").find("div[id='comment']").html(referralCode);
