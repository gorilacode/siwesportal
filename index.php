...
?>
			...
			<div class="wrap-login100">
				...
				<form id="createUser" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "">
						...
						<input class="input100" type="text" name="matricNo" id="matricNo" placeholder="Enter MatricNo">
	...
	<script type="text/javascript" src="<?php echo BASE_URL; ?>backbone/viewJs/login.js" ></script>
<?php
include(ROOT_PATH . 'inc/login_header.php');
?>
